...
BEGIN
	...
	SELECT username INTO _username FROM grape."user" WHERE user_id=_user_id::INTEGER;
	...
	IF _user_id IS NULL THEN
		RETURN (1, _user_id, _session_id, _username)::grape.access_result_type;
	END IF;
	...
	RETURN (2, _user_id, _session_id, _username)::grape.access_result_type;
